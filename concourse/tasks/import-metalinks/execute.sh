...
for compiled_metalink in $( find "data/$repository/compiled_releases" -name '*.meta4' ); do
  ...
  source_metalink="data/$repository/releases/$release_name/$release_name-$release_version.meta4"
